...
namespace WinFormsApp3
{
    partial class InsideFormAccommodations
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Size = new System.Drawing.Size(688, 84);
            this.label2.TabIndex = 20;
            this.label2.Text = "Με πάνω από 400 ξενοδοχεία σε 65 χώρες, το Crowne Plaza Athens\r\n είναι μια από τι" +
    "ς μεγαλύτερες ξενοδοχειακές μονάδες στον κόσμο με \r\nξενοδοχεία που βρίσκονται στ" +
    "α μεγάλα αστικά κέντρα και τους";
            // 
            // comboBox1
            // 
